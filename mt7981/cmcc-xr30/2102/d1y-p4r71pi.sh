...
sed -i '/cmcc,rax3000m)/i\cmcc,xr30 \|\\' package/boot/uboot-envtools/files/mediatek
sed -i '/cmcc,rax3000m-emmc)/i\cmcc,xr30-emmc \|\\' package/boot/uboot-envtools/files/mediatek
