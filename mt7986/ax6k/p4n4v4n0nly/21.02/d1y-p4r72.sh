...
wget --no-check-certificate https://raw.githubusercontent.com/0xACE8/m3d14tek/main/mt7986/ax6k/p4n4v4n0nly/21.02/zzz-updata-settings -O package/base-files/files/etc/uci-defaults/zzz-updata-settings
